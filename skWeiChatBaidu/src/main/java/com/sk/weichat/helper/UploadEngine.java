...
public class UploadEngine {
    ...
    public static void uploadImFile(String accessToken, final String loginUserId,
                                    final String toUserId, final ChatMessage message,
                                    final ImFileUploadResponse response) {
