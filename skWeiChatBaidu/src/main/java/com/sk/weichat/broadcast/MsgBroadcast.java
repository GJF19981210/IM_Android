...
public class MsgBroadcast {
    ...
    public static final String ACTION_GROUP_MODIFY = AppConfig.sPackageName + ".action.group_modify";
    ...
    public static void broadcastGroupModify(Context context) {
        context.sendBroadcast(new Intent(ACTION_GROUP_MODIFY));
    }
}
