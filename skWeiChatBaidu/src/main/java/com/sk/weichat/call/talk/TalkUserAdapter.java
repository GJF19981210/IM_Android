...
public class TalkUserAdapter extends RecyclerView.Adapter<TalkUserAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView ivTalking = itemView.findViewById(R.id.ivTalking);
        private TextView tvName = itemView.findViewById(R.id.tvName);
        private TextView tvLastRequest = itemView.findViewById(R.id.tvLastRequest);
        private TextView tvTalkLength = itemView.findViewById(R.id.tvTalkLength);
